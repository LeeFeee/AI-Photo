 ...
 * Button component
 *
 * 支持多种样式变体和尺寸，带有平滑过渡动画和焦点状态
 * Supports multiple style variants and sizes with smooth transitions and focus states
 */
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'default', size = 'default', asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      outline: 'border-2 border-gray-300 bg-transparent hover:bg-gray-100 active:bg-gray-200',
